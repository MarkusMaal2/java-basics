...
public class Ex87 {
    public static void main(String[] args) {
        ...
        System.out.println( studioManhattan.isMoreExpensiveThan(twoRoomsBrooklyn) );       // false
        System.out.println( fourAndKitchenBronx.isMoreExpensiveThan(twoRoomsBrooklyn) );   // true
    }
}
